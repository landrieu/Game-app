...
var gamesRoutes = [
    ...
    { path: 'games/detail/:id', component: detail_component_1.DetailComponent }
];
var GamesRoutingModule = (function () {
    ...
    GamesRoutingModule = __decorate([
        core_1.NgModule({
            imports: [
                router_1.RouterModule.forChild(gamesRoutes)
            ],
            exports: [
...
//# sourceMappingURL=games-routing.module.js.map